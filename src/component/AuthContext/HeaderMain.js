...
const HeaderMain = () => {
  ...
  const favoriteCount =
    photos.length > 0
      ...
      : 0;
  //cart counter
  const cartCount = cardItems.length > 0 ? cardItems.length : 0;
  return (
    <div className="flex items-center justify-center p-3 bg-white shadow-md">
      ...
      <div className="flex items-center gap-5 ml-auto">
        <span className="relative w-8">
          ...
          <span className="w-6 h-6 text-[14px] text-white bg-[#FC2872] rounded-full flex items-center justify-center absolute top-[4px] right-0 translate-x-2/4">
            {cartCount}
          </span>
        </span>
        <span className="relative w-8">
          ...
          <span className="w-6 h-6 text-xs text-white bg-[#FC2872] rounded-full flex items-center justify-center absolute top-0 right-0 translate-x-2/4">
            {favoriteCount}
          </span>
        </span>
        <button
